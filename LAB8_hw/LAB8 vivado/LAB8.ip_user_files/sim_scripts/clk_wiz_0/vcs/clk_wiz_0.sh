...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3_0" +incdir+"$ref_dir/../../../ipstatic/LAB8/LAB8.srcs/sources_1/ip/clk_wiz_0/clk_wiz_v5_3_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/clk_wiz_v5_3_0" +incdir+"$ref_dir/../../../ipstatic/LAB8/LAB8.srcs/sources_1/ip/clk_wiz_0/clk_wiz_v5_3_0" \
    "$ref_dir/../../../../LAB8.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../LAB8.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
